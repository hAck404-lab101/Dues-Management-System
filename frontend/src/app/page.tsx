        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="card">
              ...
              <p className="text-gray-600">
                On the login page, click "Forgot password?" and enter your index number or registered phone number. A verification code will be sent by SMS to the phone number on your account.
              </p>
            </div>
