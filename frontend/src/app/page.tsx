      ...
      <section className="relative bg-[#000B33] text-white min-h-screen flex items-center justify-center py-20 px-6 sm:px-12 lg:px-24 grid-bg-dark overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-10 relative z-10 w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-2">
            <Link href="/login" className="px-8 py-4 bg-[#A3E635] hover:bg-[#86EFAC] text-[#000B33] font-bold rounded-full shadow-xl shadow-[#A3E635]/25 transition-all hover:scale-105 active:scale-95 text-center min-w-[200px]">
              Get Started
            </Link>
      ...
      <section className="py-24 px-6 sm:px-12 bg-[#F9FAFB] border-t border-gray-100 relative z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div className="pt-2">
              <Link href="/login" className="inline-block px-8 py-3.5 bg-[#000B33] hover:bg-black text-[#A3E635] font-bold rounded-full transition-colors">
                Get Started
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
            ...
            <div className="bg-[#0020B2] rounded-[2rem] p-8 shadow-xl shadow-[#0020B2]/25 text-white hover:shadow-2xl transition-all duration-300 flex flex-col justify-between relative scale-105 z-10 border border-[#0020B2]">
              <div className="absolute top-0 right-8 -translate-y-1/2 bg-[#A3E635] text-[#000B33] text-[9px] font-black uppercase tracking-widest px-3.5 py-1.5 rounded-full shadow-md">Popular</div>
      ...
      <section className="bg-gradient-to-r from-[#000B33] to-[#0B1F17] text-white py-24 px-6 sm:px-12 text-center border-t border-white/5 relative z-10">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Link href="/login" className="px-8 py-4 bg-[#A3E635] hover:bg-[#86EFAC] text-[#000B33] font-bold rounded-xl shadow-xl shadow-[#A3E635]/20 transition-all hover:scale-105 active:scale-95">
