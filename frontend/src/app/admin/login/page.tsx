      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-primary overflow-hidden flex-col justify-between p-12 text-white">
        ...
        <div className="relative z-10 max-w-lg">
          <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight mb-6">
            Manage Better.<br/>Report Faster.<br/>Govern Anywhere.
          </h1>
          <p className="text-lg text-white/80 leading-relaxed">
            Access the administrative portal to oversee dues collection, approve manual payments, and monitor financial reports in real-time.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        <div className="w-full max-w-md bg-white p-8 sm:p-10 rounded-3xl shadow-2xl shadow-primary/5 border border-gray-100 relative z-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 font-medium">Log in to the management dashboard.</p>
          </div>
