    ...
    <AdminLayout title="Admin Overview">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="kpi-card solid-primary">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="percent-pill bg-white/20 text-white border border-white/30">{collectionRate}% Paid</span>
              </div>
              <div>
            ...
            <div className="kpi-card">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-xs text-gray-400 font-medium ml-1">Students</span>
                </div>
              </div>
            </div>
            ...
            <div className="kpi-card">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="percent-pill negative">Defaulters: {s.defaultersCount}</span>
              </div>
              <div>
        ...
        <div className="space-y-6 flex flex-col">
          {/* Revenue Statistic Pie Chart */}
          <div className="gradient-card flex-1 flex flex-col">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3>Revenue Statistic</h3>
                <p className="chart-subtitle text-white/70">Breakdown of collections vs outstanding</p>
              </div>
            </div>
