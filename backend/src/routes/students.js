...
router.patch('/:id/activate', authenticate, requirePermission('students.edit'), auditLog('ACTIVATE_STUDENT', 'student'), studentStatusController.activateStudent);
router.patch('/:id/deactivate', authenticate, requirePermission('students.edit'), auditLog('DEACTIVATE_STUDENT', 'student'), studentStatusController.deactivateStudent);
